...
#define SWIGTYPE_p_a_3840__int swig_types[0]
#define SWIGTYPE_p_a_3840__intArray swig_types[1]
...
/*-----------------------------------------------
              @(target):= _Cconvolution2.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Cconvolution2

#else
#  define SWIG_init    init_Cconvolution2

#endif
#define SWIG_name    "_Cconvolution2"
...
SWIGINTERN PyObject *_wrap_CMultiThreshold(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int (*arg1)[3840] ;
  ...
  swig_obj[0] = args;
  {
    ...
    arg1 = (int (*)[3840]) array_data(array1);
  }
  CMultiThreshold((int (*)[3840])arg1);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_U(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "U", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "U" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "U" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  U(arg1,arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN int Swig_var_Umap_set(PyObject *_val) {
  {
    double *inp = 0;
    int res = SWIG_ConvertPtr(_val, SWIG_as_voidptrptr(&inp), SWIGTYPE_p_double,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""Umap""' of type '""double [256]""'");
    } else if (inp) {
      size_t ii = 0;
      for (; ii < (size_t)256; ++ii) *(double *)&Umap[ii] = *((double *)inp + ii);
    } else {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""Umap""' of type '""double [256]""'");
    }
  }
  return 0;
fail:
...
SWIGINTERN PyObject *Swig_var_Umap_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(Umap), SWIGTYPE_p_double,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_UXmap_set(PyObject *_val) {
  {
    double *inp = 0;
    int res = SWIG_ConvertPtr(_val, SWIG_as_voidptrptr(&inp), SWIGTYPE_p_double,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""UXmap""' of type '""double [256]""'");
    } else if (inp) {
      size_t ii = 0;
      for (; ii < (size_t)256; ++ii) *(double *)&UXmap[ii] = *((double *)inp + ii);
    } else {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""UXmap""' of type '""double [256]""'");
    }
  }
  return 0;
fail:
...
SWIGINTERN PyObject *Swig_var_UXmap_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(UXmap), SWIGTYPE_p_double,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_result_set(PyObject *_val) {
  {
    int (*inp)[3840] = 0;
    int res = SWIG_ConvertPtr(_val, SWIG_as_voidptrptr(&inp), SWIGTYPE_p_a_3840__int,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""result""' of type '""int [2160][3840]""'");
    } else if (inp) {
      size_t ii = 0;
      for (; ii < (size_t)2160; ++ii) {
        if (inp[ii]) {
          size_t jj = 0;
          for (; jj < (size_t)3840; ++jj) result[ii][jj] = inp[ii][jj];
        } else {
          SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""result""' of type '""int [2160][3840]""'");
        }
      }
    } else {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""result""' of type '""int [2160][3840]""'");
...
SWIGINTERN PyObject *Swig_var_result_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_a_3840__int,  0 );
  return pyobj;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "CMultiThreshold", _wrap_CMultiThreshold, METH_O, NULL},
	 { "U", _wrap_U, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static void *_p_a_3840__intArrayTo_p_a_3840__int(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((int (*)[3840])  ((intArray (*)[3840]) x));
}
static swig_type_info _swigt__p_a_3840__int = {"_p_a_3840__int", "int (*)[3840]", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_a_3840__intArray = {"_p_a_3840__intArray", 0, 0, 0, 0, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_a_3840__int,
  &_swigt__p_a_3840__intArray,
  &_swigt__p_char,
  &_swigt__p_double,
  &_swigt__p_int,
  &_swigt__p_intArray,
...
static swig_cast_info _swigc__p_a_3840__intArray[] = {{&_swigt__p_a_3840__intArray, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_a_3840__int[] = {  {&_swigt__p_a_3840__int, 0, 0, 0},  {&_swigt__p_a_3840__intArray, _p_a_3840__intArrayTo_p_a_3840__int, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_a_3840__int,
  _swigc__p_a_3840__intArray,
  _swigc__p_char,
  _swigc__p_double,
  _swigc__p_int,
  _swigc__p_intArray,
...
# endif
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "Umap", Swig_var_Umap_get, Swig_var_Umap_set);
  SWIG_addvarlink(globals, "UXmap", Swig_var_UXmap_get, Swig_var_UXmap_set);
  SWIG_addvarlink(globals, "result", Swig_var_result_get, Swig_var_result_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
