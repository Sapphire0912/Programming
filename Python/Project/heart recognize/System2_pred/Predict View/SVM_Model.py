...
# 建立資料集和標籤
path = 'E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View\\Ground Truth\\'
...
# model_path = 'E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View\\svm_model2.xml'
# svm.save(model_path)

# Use Model
model = cv2.ml.SVM_load("E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View"
                        "\\svm_model2.xml")

target_dir = 'E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View\\Train\\'
predict_dir = "E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View\\Predict\\"
...
for index in range(0, 9):
    ...
    for ind, file in enumerate(all_dir):
        ...
        label = int(model.predict(feature)[1][0][0])

        write_path = predict_dir + f'000{label}\\{file}'
...
# Confusion Matrix
# 讀取正確資料的資料夾
true_data_path = 'E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View' \
                 '\\Ground Truth\\'
...
for index in range(0, len(true_data_dir)):
    ...
    count = 0
    NameList.append(true_data_dir[index].split('_')[-1])
    ...
    for i, file in enumerate(dirs):
        ...
        count += 1
    # curr_total_data.append(count)

# 讀取預測資料的資料夾
pred_path = 'E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View\\Predict\\'
...
for c in range(0, len(confusion_matrix)):
    ...
    result[NameList[c]] = {"Accuracy": accuracy, "Precision": precision, "Recall": recall, "F1Score": f1_score}

model_acc = all_tp / sum(curr_total_data)

JsonPath = "E:\\MyProgramming\\Python\\Project\\implement\\heart recognize\\System2_pred\\Predict View\\svm score2.json"
...
plt.xticks(np.arange(0, len(NameList)), ShowNameList, rotation=90)
plt.ylabel('Ground Truth')
plt.yticks(np.arange(0, len(NameList)), ShowNameList, rotation=0)
plt.show()
