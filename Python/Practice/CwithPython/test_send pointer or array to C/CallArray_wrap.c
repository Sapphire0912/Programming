...
SWIGINTERN PyObject *_wrap_handleArray(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "handleArray", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "handleArray" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "handleArray" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  handleArray(arg1,arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN int Swig_var_c_set(PyObject *_val) {
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""c""' of type '""int [5]""'");
    } else if (inp) {
      size_t ii = 0;
      for (; ii < (size_t)5; ++ii) *(int *)&c[ii] = *((int *)inp + ii);
    } else {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""c""' of type '""int [5]""'");
    }
  }
  return 0;
fail:
...
SWIGINTERN PyObject *Swig_var_c_get(void) {
  ...
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(c), SWIGTYPE_p_int,  0 );
  return pyobj;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "handleArray", _wrap_handleArray, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
